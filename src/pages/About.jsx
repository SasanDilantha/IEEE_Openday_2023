...
const About = () => {
  return (
    <React.Fragment>
      <div
        className="-mt-2 h-auto min-h-screen flex items-center justify-center bg-slate-900 bg-cover"
        style={{
          backgroundImage:
      ...
      >
        <div className="mx-2 my-20 font-md max-w-3xl items-center rounded-md bg-purple-600 p-3 text-center font-kumbha text-xl text-white shadow-2xl shadow-purple-500/50 duration-300 ease-in hover:rotate-6 hover:bg-emerald-500 hover:shadow-emerald-500/50 lg:p-8">
          <p>
